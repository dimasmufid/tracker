...
--> statement-breakpoint
ALTER TABLE "activities" ADD COLUMN "userId" text;--> statement-breakpoint
ALTER TABLE "projects" ADD COLUMN "userId" text;--> statement-breakpoint
ALTER TABLE "task_records" ADD COLUMN "userId" text;--> statement-breakpoint
ALTER TABLE "tasks" ADD COLUMN "userId" text;--> statement-breakpoint
...
ALTER TABLE "task_records" ADD CONSTRAINT "task_records_userId_user_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
